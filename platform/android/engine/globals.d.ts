...
/** 发 HTTP（OkHttp 由 Kotlin 静态方法承接），入参/返回与 NativeHttpPlugin 同形 */
declare function __nativeHttp(reqJson: string): Promise<string>;
...
/** inflate 解压（deflate / deflate-raw / gzip），入参出参均 base64 */
declare function __nativeInflate(dataB64: string, format: string): Promise<string>;
